function [x,msg] = ceiln(x,n)

%CEILN  Rounds input data up at specified power of 10
%
%  y = CEILN(x) rounds the input data x to the nearest hundredth.
%
%  y = CEILN(x,n) rounds the input data x at the specified power
%  of tens position.  For example, n = -2 rounds the input data to
%  the 10E-2 (hundredths) position.
%
%  [y,msg] = CEILN(...) returns the text of any error condition
